...
A side effect worth knowing: when every playback ends at the same configuration, the following playback's safe-entry move always begins from a known pose rather than sweeping from wherever the arm was left.
